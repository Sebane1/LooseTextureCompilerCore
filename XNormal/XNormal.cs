...
namespace FFXIVLooseTextureCompiler {
    public class XNormal {
        private static string xmlFile = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" +
            ...
            "    <Mesh Visible=\"true\" Scale=\"100.000000\" IgnorePerVertexColor=\"true\" AverageNormals=\"UseExportedNormals\" BaseTexIsTSNM=\"{4}\" File=\"{0}\" PositionOffset=\"0.0000;0.0000;0.0000\" BaseTex=\"{1}\"/>\r\n" +
            "    <Mesh Visible=\"false\" Scale=\"100.000000\" IgnorePerVertexColor=\"true\" AverageNormals=\"UseExportedNormals\" BaseTexIsTSNM=\"false\" File=\"{2}\" PositionOffset=\"0.0000;0.0000;0.0000\"/>\r\n" +
            "  </HighPolyModel>\r\n" +
        ...
        public static void CallXNormal(string inputFBX, string outputFBX, string inputImage, string outputImage, bool isNormalMap = false, int width = 4096, int height = 4096, bool skipRgbSplit = false) {
            ...
            if (!skipRgbSplit) {
                ...
                CallXNormalFinal(inputFBX, outputFBX, paths[0], path1, false, width, height);
                ...
                CallXNormalFinal(inputFBX, outputFBX, inputImage, outputImage, false, width, height);
            }
        }
